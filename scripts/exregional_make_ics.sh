...
if [[ $DO_ENS_BLENDING == "TRUE" &&
   ...
   ln_vrfy -sf $LIB64DIR/raymond.so .
   ln_vrfy -sf $LIB64DIR/chgres_winds.so .
   ln_vrfy -sf $LIB64DIR/remap_scalar.so .
   ln_vrfy -sf $LIB64DIR/remap_dwinds.so .
   ...
   ${BLENDINGPYTHON} da_chgres_cold2fv3.py $warm $cold $grid $akbk $akbkcold $orog
   ...
   ${BLENDINGPYTHON} da_blending_fv3.py $Lx $glb $reg $trcr $blend $use_host_enkf
