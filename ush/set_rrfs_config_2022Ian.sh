  ...
  if [[ $MACHINE == "orion" ]] ; then
    if [[ ${DO_ENSEMBLE} == "TRUE" ]]; then
      if [[ ${EXTRN_MDL_NAME_ICS} == "GDASENKF" ]]; then
        EXTRN_MDL_SOURCE_BASEDIR_ICS="/work2/noaa/fv3-cam/syokota/rrfs/data2/enkf/atm"
      elif [[ ${EXTRN_MDL_NAME_ICS} == "FV3GFS" ]]; then
        EXTRN_MDL_SOURCE_BASEDIR_ICS="/work2/noaa/fv3-cam/syokota/rrfs/data2/gfs"
      fi
      if [[ ${EXTRN_MDL_NAME_LBCS} == "GDASENKF" ]]; then
        EXTRN_MDL_SOURCE_BASEDIR_LBCS="/work2/noaa/fv3-cam/syokota/rrfs/data2/enkf/atm"
      elif [[ ${EXTRN_MDL_NAME_LBCS} == "FV3GFS" ]]; then
        EXTRN_MDL_SOURCE_BASEDIR_LBCS="/work2/noaa/fv3-cam/syokota/rrfs/data2/gfs"
      fi
    else
      EXTRN_MDL_SOURCE_BASEDIR_ICS=/work2/noaa/fv3-cam/syokota/rrfs/data2/gfs
      EXTRN_MDL_SOURCE_BASEDIR_LBCS=/work2/noaa/fv3-cam/syokota/rrfs/data2/gfs
    fi
    OBSPATH=/work2/noaa/fv3-cam/syokota/rrfs/data2/obs_rap
    OBSPATH_NSSLMOSIAC=/work2/noaa/fv3-cam/syokota/rrfs/data2/reflectivity
    LIGHTNING_ROOT=/work2/noaa/fv3-cam/syokota/rrfs/data2/lightning
    ENKF_FCST=/work2/noaa/fv3-cam/syokota/rrfs/data2/enkf/atm
    AIRCRAFT_REJECT="/work2/noaa/fv3-cam/syokota/rrfs/data2/amdar09"
    SFCOBS_USELIST="/work2/noaa/fv3-cam/syokota/rrfs/data2/meso09"
    SST_ROOT="/work2/noaa/fv3-cam/syokota/rrfs/data2/highres_sst"
    GVF_ROOT="/work2/noaa/fv3-cam/syokota/rrfs/data2/gvf/grib2"
    IMSSNOW_ROOT="/work2/noaa/fv3-cam/syokota/rrfs/data2/snow/ims96/grib2"
  fi
fi
